...
<html>
    <head>
        ...
        <title>Edit Users | Smarakam Admin Panel</title>
        ...
        <div class="container-fluid" id="outermost-container">
            ...
            <div class="row" id="main-content">
                ...
                <div class="col-10 " id="main-panel">
                    <div class="row">
                        <h3 class="text-center my-3">Update User Account</h3>
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    if (this.rst.next()) {
                                        ...
                                        String name = this.rst.getString("u_name");
                                        String email = this.rst.getString("u_email");
                                        String phone = this.rst.getString("u_phone");
                                       
                                        out.println("<form id='edit-user-form'>"
                                                + "<span id='form-response' class='text-center p-1 mx-auto d-block mt-3 rounded'></span>"
                                                 + "<input type='text' placeholder='New User Name' class='ro d-none' name='uid' required value='"+uid+"' >"
                                                ...
                                                + "<input type='email' placeholder='New Email ID' class='ro' name='email' required value='"+email+"'>"
                                                 + "<input type='text' placeholder='New Phone' class='ro' name='phone' required value='"+phone+"'>"
                                               
                                                + "<input type='submit' value='Submit' id='edit-user-btn' class='btn btn-primary w-75 mx-auto d-block'>"
                                                      + "</form>");
                                    } else {
                                        //redirection
                                    }
                   ...
                   $.ajax({
                       ...
                       success : function(result){
                           if(result){
                               ...
                               $("#form-response").show().html("User Updated Successfully !").addClass("alert-success").removeClass("alert-danger");
                               $(location).attr("href","view-users.jsp");
                            }else{
